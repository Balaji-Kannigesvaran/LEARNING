...
def submit():
  ...
  ip1 = ip_str.get()
  ip2=""
  ip2 = filepath_manual.get() if filepath_browse == "" else filepath_browse
  # if filepath_browse == "":
  ...
  if ((ip1_case == "") and (ip1_case == "")):
    try:
      ...
      op_diplay = Label (win, text="Error " + str(e), wraplength=500, font=('Aerial 11'),fg="red", width=60, justify=LEFT)
      op_diplay.grid(row=4,column=0, columnspan = 6, padx=10, pady=20)
